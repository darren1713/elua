...
addi( sf( 'src/platform/%s/FreakUSB/hw/sim3u1xx/si32Hal/SI32_Modules', platform ) )
addi( sf( 'src/platform/%s/FreakUSB/hw/sim3u1xx/si32Hal/sim3u1xx', platform ) )
...
fwlib_files = fwlib_files .. " " .. utils.get_files( sf( "src/platform/%s/FreakUSB/hw/sim3u1xx/si32Hal/SI32_Modules", platform ), ".*RTC.*%.c$" )
fwlib_files = fwlib_files .. " " .. utils.get_files( sf( "src/platform/%s/FreakUSB/hw/sim3u1xx/si32Hal/SI32_Modules", platform ), ".*VREG.*%.c$" )
fwlib_files = fwlib_files .. " " .. utils.get_files( sf( "src/platform/%s/FreakUSB/hw/sim3u1xx/si32Hal/SI32_Modules", platform ), ".*VMON.*%.c$" )
fwlib_files = fwlib_files .. " " .. utils.get_files( sf( "src/platform/%s/FreakUSB/hw/sim3u1xx/si32Hal/SI32_Modules", platform ), ".*AES.*%.c$" )
fwlib_files = fwlib_files .. " " .. utils.get_files( sf( "src/platform/%s/FreakUSB/hw/sim3u1xx/si32Hal/SI32_Modules", platform ), ".*SARADC.*%.c$" )
fwlib_files = fwlib_files .. " " .. utils.get_files( sf( "src/platform/%s/FreakUSB/hw/sim3u1xx/si32Hal/sim3u1xx", platform ), ".*%.c$" )
