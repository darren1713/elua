...
specific_files = "system_stm32l4xx.c startup_stm32l476xx.s platform.c platform_int.c cpu.c stm32_pio.c enc.c stm32l4xx_it.c"
...
tools.stm32l4.pre_build = function()
...
tools.stm32l4.prog_flist = { output .. ".bin", output .. ".hex" }
