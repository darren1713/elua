...
function add_platform_configs( t, board, cpu )
  t.stm32l4_uart_pins = {
    attrs = {
      con_rx_port = at.int_attr( 'STM32L4_CON_RX_PORT', 0 ),
      con_rx_pin = at.int_attr( 'STM32L4_CON_RX_PIN', 0 ),
      con_tx_port = at.int_attr( 'STM32L4_CON_TX_PORT', 0 ),
      con_tx_pin = at.int_attr( 'STM32L4_CON_TX_PIN', 0 )
    },
  ...
  t.clocks.attrs.msi = at.make_optional( at.int_attr( 'ELUA_BOARD_MSI_CLOCK_HZ', 1 ) )
end
