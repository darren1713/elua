...
To cross compile scripts on Windows (cross-lua), install msys2 32 bit link:http://repo.msys2.org/distrib/i686/msys2-i686-20161025.exe[msys2-i686-20161025.exe] and Python (ActivePython) 2.7.13, and Lua For Windows link:https://github.com/rjpcomputing/luaforwindows/releases/download/v5.1.5-51/LuaForWindows_v5.1.5-51.exe[LuaForWindows_v5.1.5-51.exe].
